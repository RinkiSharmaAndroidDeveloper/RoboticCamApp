...
/**
 * Created by offbeatDevD02 on 7/6/2016.
 */
public class FragmentRCPControl extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_rcp_control, container, false);
        ...
        resetBtnsColor();
        btn_camera_control.setBackgroundResource(R.drawable.maintance_active);
        ...
        if(dataActivity.getPanelLockStatus())
        {
            ...
            panelLock.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.admin_on_off_control, 0);
        }
        //Declare the timer
        Timer t = new Timer();
    ...
    private void resetBtnsColor (){
        btn_camera_control.setBackgroundResource(R.drawable.maintance_inactive);
        btn_elevation.setBackgroundResource(R.drawable.maintance_inactive);
        btn_predestal.setBackgroundResource(R.drawable.maintance_inactive);
    }
            ...
            switch (v.getId()) {
                case (R.id.panel_lock): {
                    if (!isPanelLock) {
                        ...
                        panelLock.setCompoundDrawablesWithIntrinsicBounds(R.drawable.admin_on_off_control, 0,0 , 0);
                ...
                case (R.id.btnautofocus): {
                    if (autofocus.isChecked()) {
                        autofocus.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.admin_on_off_control, 0);
                    } else {
                        autofocus.setCompoundDrawablesWithIntrinsicBounds(R.drawable.admin_on_off_control, 0, 0, 0);
                    }
                    break;
                }
                ...
                case (R.id.btn_elevation): {
                    if (!isPanelLock){
                        resetBtnsColor();
                        btn_elevation.setBackgroundResource(R.drawable.maintance_active);
                    }
                    break;
                }
                case (R.id.btn_predestal): {
                    if(!isPanelLock) {
                        resetBtnsColor();
                        btn_predestal.setBackgroundResource(R.drawable.maintance_active);
                    }
                    break;
                }
            }
